...
#Region "Rude checkout support"
        ...
        Public Sub CheckoutProjectFile(ByRef ProjectReloaded As Boolean)
            Dim SccManager As New DesignerFramework.SourceCodeControlManager(ServiceProvider, ProjectHierarchy)
            EnterProjectCheckoutSection()
            Try
...
#Region "IPropertyPageInternal"
        ...
        Public Overridable Sub Help(ByVal HelpTopic As String)
            DesignerFramework.DesignUtil.DisplayTopicFromF1Keyword(ServiceProvider, HelpTopic)
        End Sub
...
#Region "Delay validation helpers"
            ...
            Try
                ...
                If finalResult <> ValidationResult.Succeeded Then
                    ...
                    Else
                        ...
                        Dim dialogResult As DialogResult = DesignerFramework.DesignerMessageBox.Show(ServiceProvider, finalMessage, caption, MessageBoxButtons.OK, MessageBoxIcon.Warning)
        ...
        Private Sub PostValidation()
            ...
            Microsoft.VisualStudio.Editors.Interop.NativeMethods.PostMessage(Handle, Microsoft.VisualStudio.Editors.Common.WmUserConstants.WM_PAGE_POSTVALIDATION, 0, 0)
        End Sub
...
#Region "Common property getter/setter helpers"
        ...
        Protected Function GetCommonPropertyValueNative(ByVal prop As PropertyDescriptor) As Object
            Dim commonPropObject as Object = CommonPropertiesObject
...
#End Region
        ...
        Protected Sub ShowErrorMessage(ByVal ex As Exception, ByVal HelpLink As String)
            Dim Caption As String = SR.GetString(SR.APPDES_Title)
            DesignerFramework.DesignerMessageBox.Show(ServiceProvider, "", ex, Caption, HelpLink)
        End Sub
        ...
        Protected Sub ShowErrorMessage(ByVal errorMessage As String, ByVal ex As Exception)
            Dim Caption As String = SR.GetString(SR.APPDES_Title)
            DesignerFramework.DesignerMessageBox.Show(ServiceProvider, errorMessage, ex, Caption)
        End Sub
        ...
        Protected Sub ShowErrorMessage(ByVal errorMessage As String, ByVal HelpLink As String)
            Dim Caption As String = SR.GetString(SR.APPDES_Title)
            DesignerFramework.DesignerMessageBox.Show(ServiceProvider, errorMessage, Caption, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, HelpLink)
        End Sub
...
#End If
        ...
        Protected Overrides Sub WndProc(ByRef m As Message)
            If m.Msg = Microsoft.VisualStudio.Editors.Common.WmUserConstants.WM_PAGE_POSTVALIDATION Then
