...
#End Region
        ...
        Private Sub IPropertyPage2_Activate(ByVal hWndParent As System.IntPtr, ByVal pRect() As Microsoft.VisualStudio.OLE.Interop.RECT, ByVal bModal As Integer) Implements IPropertyPage2.Activate, IPropertyPage.Activate
            ...
            If m_PropPage IsNot Nothing Then
                Debug.Assert(Microsoft.VisualStudio.Editors.Interop.NativeMethods.GetParent(m_PropPage.Handle).Equals(hWndParent), "Property page already Activated with different parent")
                Return
            End If
        ...
        Private Function IPropertyPage_Apply() As Integer Implements IPropertyPage.Apply
            Apply()
            Return Microsoft.VisualStudio.Editors.Interop.NativeMethods.S_OK
        End Function
        ...
        Protected Overridable Sub Deactivate()
            ...
            If Not m_PropPage Is Nothing Then
                ...
                ElseIf m_wasSetParentCalled Then
                    ...
                    Microsoft.VisualStudio.Editors.Interop.NativeMethods.SetParent(m_PropPage.Handle, m_PrevParent)
                End If
        ...
        Protected Overridable Function IsPageDirty() As Integer
            ...
            Catch ex As Exception
                ...
                Return Microsoft.VisualStudio.Editors.Interop.NativeMethods.E_FAIL
            End Try
        ...
        Private Function EditProperty(ByVal dispid As Integer) As Integer
            Dim retVal As Integer = Microsoft.VisualStudio.Editors.Interop.NativeMethods.S_OK
        ...
        Private Function Create(ByVal hWndParent As IntPtr) As IntPtr
            ...
            Try
                ...
                End If
                m_PrevParent = Microsoft.VisualStudio.Editors.Interop.NativeMethods.GetParent(m_PropPage.Handle)
...
#End If
                ...
                Else
                    ...
                    Microsoft.VisualStudio.Editors.Interop.NativeMethods.SetParent(sizingParent.Handle, hWndParent)
